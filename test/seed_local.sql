...
INSERT INTO deposits (user_id, provider, transfer_code, amount, status, sepay_transaction_id, completed_at, created_at) VALUES
 (1, 'sepay', 'NAPABC123', 100000, 'completed', 'SEPAY-TX-1', datetime('now'), datetime('now'));
INSERT INTO deposits (user_id, provider, amount, status, asset, usdt_amount, exchange_rate, crypto_invoice_id, completed_at, created_at) VALUES
 (2, 'cryptobot', 150000, 'completed', 'USDT', '5', 26000, 'INV-555', datetime('now'), datetime('now'));
INSERT INTO deposits (user_id, provider, transfer_code, amount, status, created_at) VALUES
