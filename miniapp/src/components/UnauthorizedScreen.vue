...
<template>
  <Transition name="auth">
    <div
      ...
      class="fixed inset-0 z-[60] flex flex-col items-center justify-center gap-4 bg-background px-8 text-center"
    ...
    >
      ...
      <h1 class="text-[20px] font-semibold text-on-surface">{{ t('unauthorized.title') }}</h1>
      <p class="max-w-sm text-[14px] text-on-surface-variant">{{ t('unauthorized.desc') }}</p>
