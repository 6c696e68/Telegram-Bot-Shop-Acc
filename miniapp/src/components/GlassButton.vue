...
<template>
  <button
    ...
    class="tap-target btn-press inline-flex items-center justify-center gap-2 rounded-full px-4 py-2.5 text-[15px] font-semibold transition-[transform,opacity,background-color] duration-200 disabled:opacity-40"
