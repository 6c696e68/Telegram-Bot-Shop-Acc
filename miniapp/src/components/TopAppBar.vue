 ...
 *  - Nền kính (`.glass-panel`), cao 56px, tôn trọng safe-area-top.
...
<template>
  ...
  >
    <button
      ...
      @click="goBack"
    >
      <ArrowLeft :size="24" :stroke-width="2" aria-hidden="true" />
    </button>
    <span
      v-else
    ...
    <h1 class="truncate px-2 text-[20px] font-bold tracking-tight text-on-surface">{{ title }}</h1>
